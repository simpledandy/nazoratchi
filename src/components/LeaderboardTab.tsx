...
export default function LeaderboardTab({ leaderboard, fetchUserDetails }: LeaderboardTabProps) {
  return (
    <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-500 text-left">
      <header>
        <h2 className="text-4xl font-light tracking-tight mb-2">Leaderboard</h2>
        <p className="text-[#5A5A40]/60 italic">Eng ko'p taklif qilgan foydalanuvchilar</p>
      </header>
        ...
        <table className="w-full text-left">
          <thead>
            <tr className="border-b border-black/5 bg-black/5">
              <th className="px-8 py-4 text-xs font-bold uppercase tracking-widest text-[#5A5A40]">O'rin</th>
              <th className="px-8 py-4 text-xs font-bold uppercase tracking-widest text-[#5A5A40]">Foydalanuvchi</th>
              <th className="px-8 py-4 text-xs font-bold uppercase tracking-widest text-[#5A5A40]">Takliflar soni</th>
              <th className="px-8 py-4 text-xs font-bold uppercase tracking-widest text-[#5A5A40]"></th>
            </tr>
          </thead>
